...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>租赁租赁用户姓名:</label><input id="search-name" class="wu-text" style="width:100px">
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td>
	                <select id="add-accountId" name="accountId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择用户'">
		            	<c:forEach items="${accountList}" var="account">
            ...
            <tr>
                ...
                <td>
	                <select id="add-roomTypeId" name="roomTypeId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择房屋类型'">
		            	<c:forEach items="${roomTypeList}" var="roomType">
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">用户:</td>
                <td>
	                <select id="edit-accountId" name="accountId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择用户'">
		            	<c:forEach items="${accountList}" var="account">
		            	<option value="${account.id }" real-name="${account.realName }" id-card="${account.idCard }" mobile="${account.mobile }">${account.name }</option>
		            	</c:forEach>
	            	</select>	
            ...
            <tr>
                <td align="right">房屋类型:</td>
                <td>
	                <select id="edit-roomTypeId" name="roomTypeId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择房屋类型'">
		            	<c:forEach items="${roomTypeList}" var="roomType">
		            	<option value="${roomType.id }">${roomType.name }</option>
		            	</c:forEach>
	            	</select>	
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'accountId',title:'用户',width:100,formatter:function(value,row,index){
			...
			{ field:'roomTypeId',title:'房屋类型',width:150,formatter:function(value,row,index){
			...
			{ field:'name',title:'租赁用户',width:60,sortable:true},
			{ field:'idCard',title:'身份证号',width:100,sortable:true},
			{ field:'mobile',title:'手机号',width:100,sortable:true},
			{ field:'arriveDate',title:'租赁日期',width:100,sortable:true},
			{ field:'leaveDate',title:'结清日期',width:100,sortable:true},
